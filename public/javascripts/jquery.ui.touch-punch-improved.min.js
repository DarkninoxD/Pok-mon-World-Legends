...
(function (factory) {
  ...
  mouseProto._touchStart = function (event) {
    ...
    self._touchStartX = event.clientX;
    self._touchStartY = event.clientY;
  ...
  mouseProto._touchMove = function (event) {
    ...
    var holdingDownTime = new Date().getTime() - this._touchStartTime,
      movedX = Math.abs(event.clientX - this._touchStartX),
      movedY = Math.abs(event.clientY - this._touchStartY);
